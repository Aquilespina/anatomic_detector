...
/// Calculadora de características a partir de los 17 puntos del modelo
/// MoveNet/COCO que produce [PoseDetector] (ver `_getLandmarkLabel`).
class FeatureCalculator {
  // IDs de los puntos clave de MoveNet/COCO
  ...
  static double _calculateAngle(PoseLandmark p1, PoseLandmark p2) {
    if (p1.confidence == 0 || p2.confidence == 0) return 0.0;
